...
export const getProjectByIdAndWorkspaceIdService = async(
    ...
    if(!project) {
        throw new NotFoundException("Project not found or does not belong to the specific workspace")
    }

    return {project}
};

export const getProjectAndAnalyticsService = async(
    workspaceId: string,
    projectId: string,
) => {
    const project = await ProjectModel.findOne({
...
export const updateProjectService = async(
    ...
    if(!project) {
        throw new NotFoundException("Project not found or does not belong to this specific workspace");
    }
