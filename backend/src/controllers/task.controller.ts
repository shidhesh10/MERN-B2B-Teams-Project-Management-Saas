...
import { createTaskService, deleteTaskService, getAllTasksService, getTaskByIdService, updateTaskSerive } from "../services/task.service";
...
export const updateTaskController = asyncHandler(
    async(req: Request, res: Response) => {
        ...
        const { updatedTask } = await updateTaskSerive(
            workspaceId,
            projectId,
            taskId,
            body,
